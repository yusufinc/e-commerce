    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="row">
            <div class="col-md-12">
              <label class="text-black h4" for="coupon">İndirim Kodu</label>
              <p>İndirim kodunuz varsa giriniz.</p>
            </div>
            <div class="col-md-8 mb-3 mb-md-0">
              <input type="text" class="form-control py-3" id="coupon" placeholder="İndirim Kodu">
            </div>
            <div class="col-md-4">
              <button class="btn btn-primary btn-sm">İndirim Kodunu Onayla</button>
            </div>
          </div>
        </div>
            ...
            <div class="col-md-7">
              <div class="row">
                <div class="col-md-12 text-right border-bottom mb-5">
                  <h3 class="text-black h4 text-uppercase">Alışveriş Tutarı</h3>
                </div>
              </div>
              <div class="row mb-5">
                <div class="col-md-6">
